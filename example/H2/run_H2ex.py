"""Single entrypoint for H2 exact VQE (vqee) + exact QSC-EOM workflow."""
...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "H2 Full operator"
...
def _parse_args():
    parser = argparse.ArgumentParser(
        description="Run H2 exact workflow from a single script."
    )
    parser.add_argument(
        "mode",
        nargs="?",
